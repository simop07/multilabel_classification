...
Original file is located at
    https://colab.research.google.com/drive/1zxTpePDuQR6PNkqXCPz51Fh3apEf8nT2
...
if TRAIN_MODE:
  ...
  optimizer = torch.optim.AdamW(model2.parameters(), lr=LEARNING_RATE, weight_decay=WEIGHT_DECAY)
...
if TRAIN_MODE:
  ...
  optimizer_final = torch.optim.AdamW(model2_final.parameters(), lr=LEARNING_RATE, weight_decay=WEIGHT_DECAY)
